      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          @if ($umkm==NULL or $umkm->status != 2)
            <div class="card">
              <div class="card-body">
              <h5 class="card-title">Formulir Edit UMKM</h5>
                <!-- Vertical Form -->
                      ...
                      <form class="row g-3" action="{{route('user.umkm.updatePilihanKecamatan')}}" method="post">
                            ...
                            <div class="col-12">
                              ...
                              <select class="form-control {{$errors->has('kecamatan') ? 'is-invalid' : ''}}" id="kecamatan" name="kecamatan">
                                ...
                                <option value="BANTIMURUNG" {{ old('kecamatan', $umkm?->kecamatan) == 'BANTIMURUNG' ? 'selected' : '' }}>Bantimurung</option>
                    ...
                    <form  class="row g-3" action="{{route('user.umkm.update',$umkm? $umkm->id :'1000000')}}" method="post">
                      ...
                      <form method="POST" action="/form">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control {{$errors->has('bidang_usaha') ? 'is-invalid' : ''}}" id="bidang_usaha" name="bidang_usaha" value="{{ old('bidang_usaha') ?: $umkm?->bidang_usaha }}">
                        ...
                        <div class="mb-3">
                          ...
                          <select class="form-select {{$errors->has('jenis_kemitraan') ? 'is-invalid' : ''}}" id="jenis_kemitraan" name="jenis_kemitraan">
                            ...
                            <option value="Kur" {{ old('jenis_kemitraan',$umkm?->jenis_kemitraan) == 'Kur' ? 'selected' : '' }}>Kur</option>
                            <option value="Pelatihan" {{ old('jenis_kemitraan',$umkm?->jenis_kemitraan)  == 'Pelatihan' ? 'selected' : '' }}>Pelatihan</option>
                            <option value="Pemasaran" {{ old('jenis_kemitraan',$umkm?->jenis_kemitraan)  == 'Pemasaran' ? 'selected' : '' }}>Pemasaran</option>
                            <option value="Hibah" {{ old('jenis_kemitraan',$umkm?->jenis_kemitraan)  == 'Hibah' ? 'selected' : '' }}>Hibah</option>
                            <option value="Pendampingan" {{ old('jenis_kemitraan',$umkm?->jenis_kemitraan)  == 'Pendampingan' ? 'selected' : '' }}>Pendampingan</option>
                          </select>
                      ...
                      <div class="col-12  row">
                        ...
                        <div class="col-12">
                          ...
                          <div class="col-12">
                            ...
                            <input id="koordinat" type="text" class="form-control {{$errors->has('koordinat_alamat_usaha') ? 'is-invalid' : ''}}" id="" name="koordinat_alamat_usaha" value="{{old('koordinat_alamat_usaha') ?: $umkm->koordinat_alamat_usaha}}" placeholder="Contoh penulisan -5.15078,119.452467">
