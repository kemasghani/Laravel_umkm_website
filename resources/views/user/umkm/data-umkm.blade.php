                            ...
                            <table id="dataTable" class="table table-striped table-sm">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Koordinat Alamat Usaha</th>
        ...
        <script>
            function format(d) {
                ...
                return (
                    ...
                    '</tr>' +
                    '<tr>' +
                    '<td>Koordinat Alamat:</td>' +
                    '<td>' +
                    d.koordinat_alamat_usaha +
            ...
            $(document).ready(function() {
                ...
                var table = $('#dataTable').DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'koordinat_alamat_usaha',
                            name: 'koordinat_alamat_usaha'
                        },
                        {
                            data: 'modal',
                            name: 'modal'
            ...
            function editFunc(id) {
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        $('#bidang_usaha').val(res.data.bidang_usaha);
                        $('#jenis_usaha').val(res.data.jenis_usaha);
                        $('#nik').val(res.data.nik);
                        $('#nib').val(res.data.nib);
                        $('#nib_tahun').val(res.data.nib_tahun);
                        $('#pirt').val(res.data.pirt);
                        $('#pirt_tahun').val(res.data.pirt_tahun);
                        $('#npwp').val(res.data.npwp);
                        $('#npwp_tahun').val(res.data.npwp_tahun);
                        $('#halal').val(res.data.halal);
                        $('#halal_tahun').val(res.data.halal_tahun);
                        $('#haki').val(res.data.haki);
                        $('#haki_tahun').val(res.data.haki_tahun);
                        $('#modal').val(res.data.modal);
                        $('#jumlah_karyawan').val(res.data.jumlah_karyawan);
                        $('#jumlah_karyawan_pria').val(res.data.jumlah_karyawan_pria);
                        $('#jumlah_karyawan_wanita').val(res.data.jumlah_karyawan_wanita);
                        $('#tanggal_mulai_usaha').val(res.data.tanggal_mulai_usaha);
                        $('#lama_usaha').val(res.data.lama_usaha);
                        $('#omset_usaha').val(res.data.omset_usaha);
                        $('#jenis_kemitraan').val(res.data.jenis_kemitraan);
            ...
            $('#simpan').on('click', function() {
                $.ajax({
                    ...
                    data: {
                        ...
                        nik: $('#nik').val(),
                        nib: $('#nib').val(),
                        nib_tahun: $('#nib_tahun').val(),
                        pirt: $('#pirt').val(),
                        pirt_tahun: $('#pirt_tahun').val(),
                        npwp: $('#npwp').val(),
                        npwp_tahun: $('#npwp_tahun').val(),
                        halal: $('#halal').val(),
                        halal_tahun: $('#halal_tahun').val(),
                        haki: $('#haki').val(),
                        haki_tahun: $('#haki_tahun').val(),
                        modal: $('#modal').val(),
                        jumlah_karyawan: $('#jumlah_karyawan').val(),
                        jumlah_karyawan_pria: $('#jumlah_karyawan_pria').val(),
                        jumlah_karyawan_wanita: $('#jumlah_karyawan_wanita').val(),
                        tanggal_mulai_usaha: $('#tanggal_mulai_usaha').val(),
                        omset_usaha: $('#omset_usaha').val(),
                        lama_usaha: $('#lama_usaha').val(),
                        jenis_kemitraan: $('#jenis_kemitraan').val(),
                        email: $('#email').val(),
                        no_hp: $('#no_hp').val(),
            ...
            function editStatus(id) {
                ...
                Swal.fire({
                    title: 'Apakah anda yakin?',
                    text: "Data tidak bisa diubah ketika sudah di kirim!!",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-sm-4">
              ...
              <tr>
                <td>Tahun Terbit Halal  :</td>
                <td>@{{halal_tahun}}</td>
              </tr>
              <tr>
                <td>Hak Kekayaan Intelektual (Haki)  :</td>
                <td>@{{haki}}</td>
              </tr>
              <tr>
                <td>Tahun Terbit Haki  :</td>
                <td>@{{haki_tahun}}</td>
              </tr>
              <tr>
                <td>Modal Usaha  :</td>
              ...
              <tr>
                ...
                <td>@{{jumlah_karyawan_pria}}</td>
              </tr>
              <tr>
                <td>Tenaga Kerja Perempuan  :</td>
                <td>@{{jumlah_karyawan_wanita}}</td>
              </tr>
              <tr>
                <td>Mulai Usaha  :</td>
              ...
              <table cellpadding="5" cellspacing="0" style="padding-left:50px;">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    marginheight="0" 
                    marginwidth="0" 
                    src="https://maps.google.com/maps?q=@{{koordinat_alamat}}&hl=es&z=14&amp;output=embed"></td>
                </tr>
            </table>
          </div>
